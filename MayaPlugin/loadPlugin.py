...
# load plugin
#s.send(b'loadPlugin("C:/Users/BTH/Desktop/MayaPlugin/x64/Debug/MayaAPI.mll")\n')
s.send(b'loadPlugin("D:/bth-year3/Konstruktion-av-spelteknikverktyg/uppgift-3/MayaPlugin/x64/Debug/MayaAPI.mll")\n')
